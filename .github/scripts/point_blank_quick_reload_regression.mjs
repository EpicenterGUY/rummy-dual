...
ok(script.includes('이미 새 조합을 만들었어도')&&script.includes('버스트/체인 반환 제한은 그대로'),'Quick Reload text describes the non-redundant extra-new-meld rule and preserved return guard');
...
ok(!bestFinish.includes('if(s.newMeldUsed||'),'AI may finish a RUN to open a slot when a valid Quick Reload extra meld exists');
