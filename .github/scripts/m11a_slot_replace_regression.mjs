...
const master=fs.readFileSync('docs/ROGUELIKE_MASTER_PLAN.md','utf8');
...
ok(road.includes('- [ ] 카드 제거와 네임드 교체의 경제적 가치 비교'),'removal-versus-replacement economy remains open');
