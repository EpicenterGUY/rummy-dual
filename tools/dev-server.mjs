...
import {uiFixture,uiLayoutFixture} from '../tests/helpers/ux2-layout-fixture.mjs';
...
http.createServer((req,res)=>{
  ...
  if(url.pathname==='/qa/ui'){
    res.setHeader('Content-Type','text/html; charset=utf-8');return res.end(uiLayoutFixture());
  }
  if(url.pathname==='/qa/ui-scene'){
    res.setHeader('Content-Type','text/html; charset=utf-8');return res.end(uiFixture(fs.readFileSync(path.join(root,'index.html'),'utf8'),url.searchParams.get('scene')));
  }
