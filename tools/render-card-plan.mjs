...
const statuses={preserved:'유지','implemented-wave1':'1차 구현','implemented-wave2':'2차 구현','implemented-wave3':'3차 구현','implemented-wave4':'4차 구현','implemented-wave5':'5차 구현','implemented-wave6':'6차 구현','implemented-wave7':'7차 구현','implemented-wave8':'8차 구현','implemented-wave9':'9차 구현',planned:'구현 대기'};
...
export function render(){
 ...
 `현재 PR의 적용 범위는 개편 ${implemented}종이며, ${pending?`기존 카드 추가 ${pending}종과 `:'기존 122종은 목표 효과와 일치하며, '}신규 SEASON-BLOOM 24종은 설계 완료·구현 대기다. 카드군 전체 개편 완료는 모든 예정 카드의 구현·선택 UI·AI·혼합 회귀를 마쳤을 때만 선언한다.`,'',
