...
- [x] V-SIGNAL 동일 슬롯 공용 대비 감사 — 24장 전부 직접 비교, 명백한 저효율 4장만 상향: 팬 서비스 보호막 12→16 / 기념 방송 체력 8+재생1+보호막16 / 100만 구독 보호막 8→16 / 신인 2기생 두 번째 새 조합 시 +1 후 무료 정비. 콜라보 신청·24시간 내구방송 등 나머지 20장은 공용에 없는 질적 기능 때문에 현 상태 유지, M12 표본에서 2차 확인
- [x] ZERO-SIGHT 동일 슬롯 공용 대비 감사 — 18장 전부 직접 비교, 4장 상향: 철갑탄 +10/14→+12/16, 장거리 사격 +16→+20, 호흡 조절 보호막 12→16, 예비 탄창 덱 위 2→3장 정렬. 사각지대 C5·관측 드론 CJ는 공용 C5/CJ가 S급 감시 대상이라 무리한 행동 제한 우회 상향은 보류
