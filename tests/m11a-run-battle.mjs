...
for(const n of ['ROGUELIKE_ROUTE_LIMITS','ROGUELIKE_ENDGAME','ROGUELIKE_COMMON_START_ROUTE','ROGUELIKE_REGIONS','NAMED','CHARACTERS','ROGUELIKE_STARTER_IDS','ROGUELIKE_STARTER_REGULAR_SLOTS','ROGUELIKE_STARTER_LOADOUTS','ROGUELIKE_REWARD_ROLES'])vm.runInContext(declaration(n),ctx);
...
install(ctx,'roguelikeBattleProgress','roguelikePendingRewardNode','roguelikeRunRoute','roguelikeRegionRoute','roguelikeEndgameRoute','normalizeRoguelikeStarterId','roguelikeStarterUnlocked','roguelikeStarterProfile','roguelikeStarterLoadout','roguelikeStarterDeckPlan','createRoguelikeRunDeck','normalizeRoguelikeRunDeck','createRoguelikeRewardNodes','normalizeRoguelikeRewardNodes','roguelikeRunDeckSignature','roguelikeRewardNodeId','createRoguelikeRunDraft','normalizeRoguelikeRunDraft','parseRegularId','namedSlot','makeCard','shuffle','roguelikeBattleCardFromBlueprint','makeRoguelikeBattleDeck','roguelikeBattleDeckFingerprint');
