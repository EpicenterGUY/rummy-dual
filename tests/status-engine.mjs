...
ok(JSON.stringify(Object.keys(OFFICIAL_STATUS))===JSON.stringify(['vulnerable','seal','fixed','protect','regen','loaded','damp','overheat','endure','defer','comeback','fracture','mark']),'wave 3 registers thirteen implemented shared statuses');
