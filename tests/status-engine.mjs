...
ok(JSON.stringify(Object.keys(OFFICIAL_STATUS))===JSON.stringify(['vulnerable','seal','silence','fixed','protect','regen','loaded','damp','overheat','endure','defer','comeback','fracture','mark']),'wave 6 registers fourteen implemented shared statuses');
