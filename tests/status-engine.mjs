...
ok(JSON.stringify(Object.keys(OFFICIAL_STATUS))===JSON.stringify(['vulnerable','seal','silence','flexible','echo','fixed','protect','regen','loaded','damp','overheat','endure','defer','comeback','fracture','mark']),'wave 8 registers sixteen implemented shared statuses');
