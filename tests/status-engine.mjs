...
ok(JSON.stringify(Object.keys(OFFICIAL_STATUS))===JSON.stringify(['vulnerable','seal','silence','flexible','fixed','protect','regen','loaded','damp','overheat','endure','defer','comeback','fracture','mark']),'wave 7 registers fifteen implemented shared statuses');
