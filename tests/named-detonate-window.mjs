...
ok(fx.includes("case'heal2':if(side.detonateMemory>0)runEffectAction('heal',{actor:w,source:c},{amount:3})"),'Phoenix heals only when actually used during the preserved previous-DETONATE window');
