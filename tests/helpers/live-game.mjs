...
export function makeGame(sourceHtml=html,seed=1,options={}){
  ...
  const element=()=>({classList:{add(){},remove(){},toggle(){},contains(){return false}},style:{},dataset:{},textContent:'',innerHTML:'',hidden:false,disabled:false,appendChild(){},addEventListener(){},setAttribute(){},removeAttribute(){},focus(){},getBoundingClientRect(){return{left:0,top:0,width:80,height:112}},closest(){return null},querySelector(){return null},querySelectorAll(){return[]}});
