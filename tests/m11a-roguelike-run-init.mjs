...

{
  ...
  vm.runInContext(script.slice(script.indexOf('const ROGUELIKE_COMMON_START_ROUTE='),script.indexOf('function roguelikeRegionRewardProfile(')),ctx);
  install(ctx,'roguelikeBattleProgress','roguelikePendingRewardNode','roguelikeRunRoute','roguelikeRegionRoute','roguelikeEndgameRoute');
