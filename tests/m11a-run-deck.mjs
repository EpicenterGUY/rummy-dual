...
for(const n of ['ROGUELIKE_ROUTE_LIMITS','ROGUELIKE_ENDGAME','ROGUELIKE_COMMON_START_ROUTE','ROGUELIKE_REGIONS','NAMED','CHARACTERS','TENDENCY_BY_TAG','ROGUELIKE_STARTER_IDS','ROGUELIKE_STARTER_REGULAR_SLOTS','ROGUELIKE_STARTER_LOADOUTS','ROGUELIKE_REWARD_ROLES','ROGUELIKE_THEME_ENTRY_TAGS'])vm.runInContext(declaration(n),ctx);
...
for(const starter of ['wanderer','collector','salvager','jester','pure']){
 const d=ctx.prepareRoguelikeRunDraft(starter);ok(d.version===8&&d.runDeck.cards.length===30,starter+' creates persistent 30-card deck');
