...
const direct=new Set(['finalUltimatum','blackBullet','fuseRound','zsArmorPiercing','zsCounterTrace','zsLongShot','zsBallistics','zsOneShot','pbBuckshot','pbZeroRange','pbMagDump','mrHazardMail','mrFinalNotice']);
