...
ok(script.includes("const THEME_TUTORIALS=Object.freeze({'v-signal':Object.freeze({themeId:'v-signal',startStep:null,live:false})"),'theme tutorial registry starts explicit and non-live');
