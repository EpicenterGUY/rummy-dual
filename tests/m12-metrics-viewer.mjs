...
for(const id of ['battleMetricsCount','battleMetricsReadiness','battleMetricsOverview','battleMetricsCohorts','battleMetricsThemeMatrix','battleMetricsCharacterMatrix','battleMetricsMatchedContexts','battleMetricsSignals','battleMetricsList','battleMetricsCopyBtn','battleMetricsClearBtn'])ok(html.includes(`id="${id}"`),`developer panel exposes ${id}`);
