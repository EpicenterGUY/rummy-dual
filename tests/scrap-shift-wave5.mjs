...
function context(extra={}){return vm.createContext({console,Set,Map,Array,Object,Number,String,Boolean,Math,applyScrapShiftModuleBus:()=>false,noteScrapShiftTurnAction:()=>false,scrapShiftMainFrameProtect:()=>false,...extra})}
...
ok(script.includes("themeId:'scrap-shift',live:true"),'wave5 behavior remains present after SCRAP-SHIFT live promotion');
