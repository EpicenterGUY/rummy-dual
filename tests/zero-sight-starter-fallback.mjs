...
function context(extra={}){const ctx=vm.createContext({console,Set,Map,Array,Object,Number,String,Boolean,Math,meldsOf:()=>[],switchName:w=>w,log:()=>{},...extra});installStatusRuntime(ctx,script);return ctx}
