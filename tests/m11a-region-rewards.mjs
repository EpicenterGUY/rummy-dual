...
const baselinePicks={pure:['PBH7','S4','H3'],wanderer:['C8','S4','H3'],collector:['VSD4','D4','H3'],salvager:['S8','VSD4','D7B'],jester:['D3','H9','H3']};
...
for(const starterId of starters){
 ...
 assert.deepEqual(ids(baseline),baselinePicks[starterId],starterId+' common-start ranking stays unchanged');
